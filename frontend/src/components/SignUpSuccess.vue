    ...
    <div class='flex items-center justify-center min-h-screen bg-gray-200'>
        <div
            ...
            <section class="h-full flex flex-col items-start justify-end gap-1">
                <h1 class="text-base font-semibold text-zinc-800 antialiased">Thank you for registering</h1>
                <p class="text-sm font-medium text-zinc-400 antialiased">We sent a confirmation link to your email. Please confirm your email</p>
            </section>
